...
function Testimonials ({subscribeRef}){
  const stories = [
    {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: "700", fontSize: "1.5rem" }}>Testimonials</div>
      ...
      <Carousel
        ...
        autoPlay={true}
        centerMode={false}
        className="testimonial-story-slider"
      ...
      >
        {stories.map((story, index) => (
          <div className="card" key={index} style={{ margin: "0 5px" }}>
            <div className="slide d-flex flex-row align-items-center gap-5">
              ...
              <div className="card-body">
                ...
                />
                <p id="testimonial-desc">{story.description}</p>
                <FaQuoteRight
                  size={25}
                ...
                <div className="d-flex my-5 gap-5 justify-content-between">
                  <div className="subscribe">
                    <p style={{ fontWeight: "bold" }}>Ritika Sharma</p>
                    <p>Subscribe to read such inspiring stories</p>
                    <button
                    onClick={(e) => {
                      e.preventDefault();
                      scrollToSubscribe();
