...
function FutureWorks() {
  return (
    <div style={{ margin: "100px 0" }}>
      <div
        className="d-flex justify-content-center text-md-center"
        style={{ padding: "0 20px" }}
      >
        <h2 style={{ marginBottom: "20px", fontWeight: "700" }}>
          Fund For Bharat is where the Future works
        </h2>
      </div>
      <div
        className="d-flex  justify-content-center text-md-center"
        style={{ padding: "0 20px" }}
      >
        {/* <p>Fund for Bharat is where the Future works</p> */}
        <p style={{ width: "730px", marginBottom: "40px", fontSize: "18px" }}>
      ...
      <div className="container">
        <div
          className="row d-flex justify-content-md-around gap-3 gap-md-0"
          style={{ fontSize: "18px" }}
        >
          <div className="col-12 col-md-5 col-lg-4 d-flex flex-column gap-2">
            <svg
              fill="none"
              height="48"
              viewBox="0 0 48 48"
          ...
          <div className="col-12 col-md-5 d-flex col-lg-4 flex-column gap-2">
            <svg
              width="48"
              height="48"
              fill="none"
            ...
            <span style={{ fontWeight: "700" }}>Inclusive</span>
            <p>
          ...
          <div className="col-12 col-md-5 d-flex col-lg-4 flex-column gap-2">
            ...
            <span style={{ fontWeight: "700" }}>Flexible</span>
            <p>
